...
{
    public class TopBorder : IBorder
    {
        internal OpenXmlSpreadsheet.TopBorder border { get; }
        ...
        internal TopBorder(OpenXmlSpreadsheet.TopBorder topBorder)
        {
            this.border = topBorder;
        }
    }
}
