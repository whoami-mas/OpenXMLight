...
{
    public class LeftBorder : IBorder
    {
        internal OpenXmlSpreadsheet.LeftBorder border { get; }
        ...
        internal LeftBorder(OpenXmlSpreadsheet.LeftBorder leftBorder)
        {
            this.border = leftBorder;
        }
    }
}
