...
{
    public class BottomBorder : IBorder
    {
        internal OpenXmlSpreadsheet.BottomBorder border { get; }
        ...
        internal BottomBorder(OpenXmlSpreadsheet.BottomBorder bottomBorder)
        {
            this.border = bottomBorder;
        }
    }
}
