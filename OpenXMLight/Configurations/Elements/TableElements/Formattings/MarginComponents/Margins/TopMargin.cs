...
{
    public class TopMargin : MarginBase, IElementBase<OpenXmlElement.TopMargin>
    {
        private string width;

        public OpenXmlElement.TopMargin ElementXml { get; set; }
        ...
        {
            ElementXml = xml as OpenXmlElement.TopMargin ?? new() { Type = Type.Value };

            width = ConvertWidth(ElementXml.Width, Type);
        }


        public static implicit operator OpenXmlElement.TopMargin(TopMargin build) => build.ElementXml;
    }
}
