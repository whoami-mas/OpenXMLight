...
{
    public class RightMargin : MarginBase, IElementBase<OpenXmlElement.RightMargin>
    {
        private string width;

        public OpenXmlElement.RightMargin ElementXml { get; set; }
        ...
        {
            ElementXml = xml as OpenXmlElement.RightMargin ?? new() { Type = Type.Value };

            width = ConvertWidth(ElementXml.Width, Type);
        }


        public static implicit operator OpenXmlElement.RightMargin(RightMargin build) => build.ElementXml;
    }
}
